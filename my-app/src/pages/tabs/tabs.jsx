...
// const moveRight = () => {
//   const checkedLeftColumn = checkedItems.filter((item) =>
//     leftColumn.includes(item)
//   );
//   setLeftColumn(leftColumn.filter((item) => !checkedItems.includes(item)));
//   setRightColumn([...rightColumn, ...checkedLeftColumn]);
//   setCheckedItems(checkedItems.filter((item) => rightColumn.includes(item)));
// };

// const moveLeft = () => {
//   const checkedRightColumn = checkedItems.filter((item) =>
//     rightColumn.includes(item)
//   );
//   setRightColumn(rightColumn.filter((item) => !checkedItems.includes(item)));
//   setLeftColumn([...leftColumn, ...checkedRightColumn]);
//   setCheckedItems(checkedItems.filter((item) => leftColumn.includes(item)));
// };
...
//     if(countOccurrences[letter]){
//       countOccurrences[letter]++
//     } else {
//       countOccurrences[letter] = 1
//     }
//   })

//   let uniqueLetter = '';

//   for(const letter in countOccurrences){
//     if(countOccurrences[letter] === 1){
//       uniqueLetter = letter;
//       break
//     }
//   }
